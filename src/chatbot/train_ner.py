...
train_data = [
    ...
    ("경기도 파주시 겨울 에 별 보 기 좋 은 차 박 지 추천 해줘", [(0, 3, "gpe"), (4, 7, "city"), (8, 10, "season"), (13, 14, "theme")]),
    ...
    ("충청남도 남일면 겨울 에 별 보 기 좋 은 곳 추천 해줘", [(0, 4, "gpe"), (5, 8, "city"), (9, 11, "season"), (14, 15, "theme")]),
    ("제주특별시 제주시 겨울 에 반려 동물 이랑 가 기 좋 은 곳 추천 해줘", [(0, 5, "gpe"), (6, 9, "city"), (10, 12, "season"), (15, 17, "theme")]),
    ("경상북도 경산시 봄 에 별 보 기 좋 은 곳 추천 해줘", [(0, 4, "gpe"), (5, 8, "city"), (9, 10, "season"), (13, 14, "theme")]),
    ("경상남도 창원시 여름 에 가 기 좋 은 커플 차 박 지 추천 해줘", [(0, 4, "gpe"), (5, 8, "city"), (9, 11, "season"), (22, 24, "theme")]),
    ("전라남도 대구면 여름 에 별 보 기 좋 은 곳 추천 해줘", [(0, 4, "gpe"), (5, 8, "city"), (9, 11, "season"), (14, 15, "theme")]),
    ("경상남도 진주시 겨울 에 가 기 좋 은 가족 이 가 기 좋 은 차 박 지 추천 해줘", [(0, 4, "gpe"), (5, 8, "city"), (9, 11, "season"), (22, 24, "theme")]),
    ...
    ("전라북도 남원시 겨울 에 별 보 러 가 기 좋 은 곳 추천 해줘", [(0, 4, "gpe"), (5, 8, "city"), (9, 11, "season"), (14, 15, "theme")]),
    ("강원도 추천시 겨울 에 반려 근처 좋 은 차 박 지 추천 해줘", [(0, 3, "gpe"), (4, 7, "city"), (8, 10, "season"), (13, 15, "theme")]),
    ...
    ("경기도 안산시 가을 에 가 기 좋 은 커플 끼리 가 기 좋 은 차 박 지 추천 해줘", [(0, 3, "gpe"), (4, 7, "city"), (8, 10, "season"), (21, 23, "theme")]),
    ("경기도 시흥시 봄 에 가 기 좋 은 별 근처 차 박 지 추천 해줘", [(0, 3, "gpe"), (4, 7, "city"), (8, 9, "season"), (20, 21, "theme")]),
    ...
    ("강원도 횡성군 봄 에 가족 이랑 근처 좋 은 곳 추천 해줘", [(0, 3, "gpe"), (4, 7, "city"), (8, 9, "season"), (12, 14, "theme")]),
    ("강원도 인제군 봄 에 반려 동물 이랑 가 기 좋 은 차 박 지 추천 해줘.", [(0, 3, "gpe"), (4, 7, "city"), (8, 9, "season"), (12, 14, "theme")]),
    ("경상북도 포항시 여름 에 가족 쪽 차 박 지 추천 해줘.", [(0, 4, "gpe"), (5, 8, "city"), (9, 11, "season"), (14, 16, "theme")]),
    ...
    ("전라북도 고창군 봄 에 별 보기 좋은 근처 차 박 지 추천 해줘.", [(0, 4, "gpe"), (5, 8, "city"), (9, 10, "season"), (13, 14, "theme")]),
    ("전라북도 무주군 가을 에 가 기 좋 은 바다 근처 차 박 지 추천 해줘", [(0, 4, "gpe"), (5, 8, "city"), (9, 11, "season"), (22, 24, "theme")]),
    ("울산광역시 울주군 봄 에 가 기 좋 은 힐링 하기 좋 은 곳 추천 해줘", [(0, 5, "gpe"), (6, 9, "city"), (10, 11, "season"), (22, 24, "theme")]),
]
